"""
Django settings for saasproj project.
...
WSGI_APPLICATION = "saasproj.wsgi.application"
...
ACCOUNT_EMAIL_SUBJECT_PREFIX = "[Vector]"
...
# Add the path to your custom login form
ACCOUNT_FORMS = {
